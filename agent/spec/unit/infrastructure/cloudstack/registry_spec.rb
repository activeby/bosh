...
describe Bosh::Agent::Infrastructure::Cloudstack::Registry do
  ...
  it 'should get settings' do
    Bosh::Agent::Infrastructure::Cloudstack::Registry.stub(:current_server_id).and_return("i-server")
    Bosh::Agent::Infrastructure::Cloudstack::Registry.stub(:get_json_from_url).and_return(@settings)
    Bosh::Agent::Infrastructure::Cloudstack::Registry.stub(:get_registry_endpoint).and_return("blah")
  ...
  it 'should get registry endpoint' do
    ...
    Bosh::Agent::Infrastructure::Cloudstack::Registry.stub(:get_json_from_url).and_return(endpoint)
    Bosh::Agent::Infrastructure::Cloudstack::Registry.get_registry_endpoint.should == "blah"
  end
  ...
  it 'should get current_server_id' do
    ...
    server_id = Bosh::Agent::Infrastructure::Cloudstack::Registry.current_server_id
