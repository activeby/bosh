...
describe Bosh::Agent::Infrastructure::Cloudstack::Settings do
  ...
  it 'should load settings' do
    Bosh::Agent::Infrastructure::Cloudstack::Registry.stub(:get_settings).and_return(@settings)
    Bosh::Agent::Infrastructure::Cloudstack::Registry.stub(:get_openssh_key).and_return("test_key")
    settings_wrapper = Bosh::Agent::Infrastructure::Cloudstack::Settings.new
