...
# cloudstack specific packages(grub is not actually installed, we just need /boot/grub/menu.lst for pv-grub)
...
cp -r $lib_dir/cloudstack $target/var/vcap/bosh/src/

chroot $target /var/vcap/bosh/src/cloudstack/configure_cloudstack.sh